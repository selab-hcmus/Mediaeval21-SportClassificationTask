...
if __name__ == "__main__":
    # specify 
    config_file = '/home/nttung/Challenge/MediaevalSport/MMAction/mmaction2/first_component/config_1.py'
    # checkpoint_file = '/home/nttung/Challenge/MediaevalSport/MMAction/mmaction2/first_component/first_component_train_old/epoch_40.pth'
    checkpoint_file = '/home/nttung/Challenge/MediaevalSport/MMAction/mmaction2/first_component/checkpoint_and_log_no_bn_new/epoch_80.pth'
    device = 'cuda:0'
    device = torch.device(device)

    # path
    path_frames_vid_val = '/home/nttung/Challenge/MediaevalSport/MMAction/processed_frame/valid/*'
    path_gt_val_txt = '/home/nttung/Challenge/MediaevalSport/MMAction/processed_txt_first_component/val_annotate.txt'
    path_json_out = './predict_val_mmaction_first_component_v1.json'

    # first write label path
    label_path = './label.txt'
    with open(label_path, "w") as fp:
        fp.write('\n'.join(name_component_to_id_1))
    ...
    for vid_fr_path in glob.glob(path_frames_vid_val):
        ...
        pred_id = name_component_to_id_1.index(max_pred[0])
