...
if __name__ == "__main__":
    ...
    path_gt_val_txt = '/home/nttung/Challenge/MediaevalSport/MMAction/processed_txt_third_component/val_annotate.txt'
    path_json_out = './predict_val_mmaction_third_component.json'
    ...
    for vid_fr_path in glob.glob(path_frames_vid_val):
        ...
        json_result[json_key]["Gt"] = name_component_to_id_3[gt_label]
